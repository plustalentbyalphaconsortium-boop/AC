      ...
      <div className="mx-auto max-w-3xl py-32 sm:py-48 lg:py-56">
        <div className="mb-8">
           <div className="text-gray-500 dark:text-gray-400 mb-4">
            Welcome! Today is {today}.
          </div>
          <div className="inline-flex items-center rounded-full border border-blue-500/30 px-3 py-1 text-sm leading-6 text-gray-600 dark:text-gray-300 ring-1 ring-inset ring-blue-500/20">
        ...
        <div className="mt-10 flex items-center justify-center gap-x-6">
          ...
          <a href="#features" className="text-base font-semibold leading-6 text-gray-800 dark:text-white group">

    ...
    <footer className="bg-gray-900/50 border-t border-gray-700/50">
      <div className="max-w-7xl mx-auto py-12 px-4 sm:px-6 lg:px-8">
            ...
            <div className="md:grid md:grid-cols-2 md:gap-8">
              <div>
                ...
                <ul className="mt-4 space-y-4">
                  <li><a href="#" className="text-base text-gray-400 hover:text-white">Job Search</a></li>
                  <li><a href="#" className="text-base text-gray-400 hover:text-white">Training</a></li>
                  <li><a href="#" className="text-base text-gray-400 hover:text-white">Recruitment</a></li>
                </ul>
              </div>
        ...
        <div className="mt-12 border-t border-gray-700 pt-8">
          <p className="text-base text-gray-400 xl:text-center">&copy; {currentYear} Alpha Consortium. All rights reserved.</p>
        </div>
      </div>
    </footer>
  );
